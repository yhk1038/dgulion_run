class HomeController < ApplicationController
  ...
  def main
    ...
    @mem4=['김귀현', '김남균', '김보미', '김성배', '김은식', '김자영', '김지원', '노종원', '박성준', '박승현', '백기목', '송다혜', '송은지', '신새날', '왕대현', '유선우', '이가을', '이소희', '이은영', '이지훈', '정순우', '정재호', '조다빈', '조유림', '조이슬', '조지연', '조현욱', '추정호', '한주혜', '황고운']
    @mem4h=['정보통신공학과', '경영학부', '경영학부', '컴퓨터공학과', '경영학부', '경영학부', '전자전기공학부', '회계학과', '회계학과', '컴퓨터공학과', '국제통상학과', '경제학과', '북한학과', '생명과학과', '정보통신공학과', '컴퓨터공학과', '전자전기공학부', '북한학과', '정보통신공학과', '수학과', '산업시스템공학과', '정보통신공학과', '경영학부', '수학과', '신문방송학과', '경영학부', '정보통신공학과', '정보통신공학과', '정보통신공학과', '경영학부']
